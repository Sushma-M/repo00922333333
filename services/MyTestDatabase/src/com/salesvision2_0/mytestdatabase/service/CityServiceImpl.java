...
public class CityServiceImpl implements CityService {
	...
	public City create(City cityInstance) {
        ...
        if(personnels != null) {
            for(Personnel _personnel : personnels) {
                _personnel.setCity(cityInstanceCreated);
                LOGGER.debug("Creating a new child Personnel with information: {}", _personnel);
                personnelService.create(_personnel);
            }
        }
