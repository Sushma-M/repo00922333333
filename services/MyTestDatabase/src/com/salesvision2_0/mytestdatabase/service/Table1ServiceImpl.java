...
public class Table1ServiceImpl implements Table1Service {
	...
	public Table1 create(Table1 table1) {
        ...
        if(table2s != null) {
            for(Table2 _table2 : table2s) {
                _table2.setTable1(table1Created);
                LOGGER.debug("Creating a new child Table2 with information: {}", _table2);
                table2Service.create(_table2);
            }
        }
