...
public class StatesServiceImpl implements StatesService {
	...
	public States create(States states) {
        ...
        if(customerses != null) {
            for(Customers _customers : customerses) {
                _customers.setStates(statesCreated);
                LOGGER.debug("Creating a new child Customers with information: {}", _customers);
                customersService.create(_customers);
            }
        }
