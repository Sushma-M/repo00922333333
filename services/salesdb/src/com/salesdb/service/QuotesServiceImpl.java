...
public class QuotesServiceImpl implements QuotesService {
	...
	public Quotes create(Quotes quotes) {
        ...
        if(saleses != null) {
            for(Sales _sales : saleses) {
                _sales.setQuotes(quotesCreated);
                LOGGER.debug("Creating a new child Sales with information: {}", _sales);
                salesService.create(_sales);
            }
        }

        if(followUpses != null) {
            for(FollowUps _followUps : followUpses) {
                _followUps.setQuotes(quotesCreated);
                LOGGER.debug("Creating a new child FollowUps with information: {}", _followUps);
                followUpsService.create(_followUps);
            }
        }
